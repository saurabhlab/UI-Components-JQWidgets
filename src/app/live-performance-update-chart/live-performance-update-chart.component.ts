...
@Component({
  selector: 'app-live-performance-update-chart',
  templateUrl: './live-performance-update-chart.component.html',
  styleUrls: ['./live-performance-update-chart.component.css']
})
export class LivePerformanceUpdateChartComponent implements OnInit {
