...
@Component({
  selector: 'app-live-column-update-chart',
  templateUrl: './live-column-update-chart.component.html',
  styleUrls: ['./live-column-update-chart.component.css']
})
export class LiveColumnUpdateChartComponent implements AfterViewInit  {
